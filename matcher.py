...
class EmbeddingMatcher:
    ...
    @staticmethod
    def find_best_match(query_embedding: Union[List, Any], 
        ...
        if cosine is None:
            ...
            embedded_tuple = stored_embeddings[person_id]
            return person_id, 0.5
        
        best_person = None
        best_similarity = 0.0
        
        for person_id, (stored_embedding, camera, confidence) in stored_embeddings.items():
    ...
    @staticmethod
    def find_top_k_matches(query_embedding: Union[List, Any],
                          stored_embeddings: Dict[str, Tuple[Union[List, Any], str, float]],
                          k: int = 5,
    ...
    @staticmethod
    def batch_match(query_embeddings: Union[List[List], Any],
                   stored_embeddings: Dict[str, Tuple[Union[List, Any], str, float]],
