...
def publish_face_event(client, person_name, confidence, camera, color="red"):
    ...
    print(
        f"Published FACE event: {person_name} at {camera} (confidence: {confidence:.2f})"
    )
...
def main():
    ...
    try:
        ...
        print(
            "Check Home Assistant MQTT sensors: identity/person/recognized and identity/person/tracked"
        )
